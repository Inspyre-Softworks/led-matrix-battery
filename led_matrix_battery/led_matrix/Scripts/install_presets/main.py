...
File:
    led_matrix_battery/led_matrix/Scripts/install_presets/main.py
...
Dependencies:
    ...
    - led_matrix_battery.led_matrix.display.grid.presets.manifest.GridPresetManifest
...
from led_matrix_battery.common.helpers.github_api import assemble_github_content_path_url as assemble_url, REPO_PRESETS_URL
